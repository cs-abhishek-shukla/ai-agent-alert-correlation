...
- **Scope**: Analysis and Investigation, Triage

- **Verified with Models**: Fortinet FortiAI (AI model Medium)

# Alert Correlation Agent

Retrieves and analyzes previous alerts and associated IOC's to surface potential attack sequences, recurring behaviors, and possible threat campaign relationships for investigation.
...
| `indicators` | List of indicator values as strings. |
